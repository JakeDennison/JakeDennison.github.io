    ...
    `}createFooter(t){const e=this.statusColors[t]||{selectedStatus:""},s=this.itemValues[t]?.comment||"",i=`comments-${t}`,r=this.itemValues[t]?.history||[],n=this.itemValues[t]?.showAllHistory||!1;return P`
      <div class="card-footer">
        ...
        <div class="history-area mt-3">
          <h5>History</h5>
          ${r.slice(0,n?r.length:1).map((t=>P`
          <div class="card mb-2">
            <div class="card-body">
              <p><strong>Status:</strong> ${t.status}</p>
              <p><strong>Comment:</strong> ${t.comment}</p>
              <p><strong>Context User:</strong> ${t.contextuser}</p>
              <p><strong>Log Time:</strong> ${t.logtime}</p>
            </div>
          </div>
          `))}
          ${r.length>1?P`
