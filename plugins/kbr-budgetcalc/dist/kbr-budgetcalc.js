          ...
          ${r.slice(0,n?r.length:1).map((t=>{const e=new Date(t.logtime).toLocaleString("en-GB",{day:"numeric",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"});return P`
              <div class="card mb-1">
                <div class="card-header badge-container">
                  <div class="badge fs-6 rounded-pill ${"Approved"===t.status?"bg-success":"bg-danger"} badge-left">${t.status}</div>
